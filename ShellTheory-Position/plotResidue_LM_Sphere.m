function [] = plotResidue_LM_Sphere(Np, Pp, zetacz)
close all;
global N;
global I;
N=round(Np/2)
...
[r]=residuals_LM_sphere_adpatedToCompressed(X);
...
xlabel('Point')
ylabel('Residue')
legend('\zeta Contact', 'r Contact', '\zeta Free', 'r Free','Location','northwest'); %, 'Pressure', '\zeta_c')
% minR=1*10^60;
% hmin=0;

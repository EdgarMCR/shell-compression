function [Y] = problem_inflatingSphere_nonDim(Np, p, X, pathToSol,save_data,  savePath)
...
func =@residuals_inflatingSphere_nonDim;
...
global counter;
filename=sprintf('InflatedSphere\\Plot_Solution_InflatedSphere_Np=%d_p=%.2e_%d.png',Np, P, counter);
